...
public class ActionDocumentRejectedByCEO implements Action {
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response)
		...
		List<RejectedDocumentVO> list = rejDocDao.getRejectedDocumentByCEO(Integer.parseInt(id));
		rejDocDao.dbClose();
		
		request.setAttribute("docList", list);
		
		ActionForward af = new ActionForward();
		af.setPath("documentRejectedByCEO.jsp");
