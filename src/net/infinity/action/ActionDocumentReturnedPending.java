...
public class ActionDocumentReturnedPending implements Action {
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response)
		...
		List<RejectedDocumentVO> list = rejDocDao.getDocumentReturnedPendingToTeamLeader(Integer.parseInt(id));
		rejDocDao.dbClose();
		
		request.setAttribute("docList", list);
		
		ActionForward af = new ActionForward();
		af.setPath("documentReturnedPending.jsp");
