...
public class ActionPendingSendingToCEO implements Action {
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response)
		...
		List<DocumentVO> list = docDao.getPendingSendingToCEO(teamLeaderNo);
		docDao.dbClose();
		
		request.setAttribute("docList", list);
		
		ActionForward af = new ActionForward();
		af.setPath("PendingSendingToCEO.jsp");
		af.setRedirect(false);
	
		System.out.println("ActionPendingSendingToCEO executed");
		return af;
	}
}
