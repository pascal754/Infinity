...
public class ActionDocumentRejected implements Action {
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response)
		...
		List<RejectedDocumentVO> list = rejDocDao.getRejectedDocument(Integer.parseInt(id));
		rejDocDao.dbClose();
		
		request.setAttribute("docList", list);
		
		ActionForward af = new ActionForward();
		af.setPath("documentRejected.jsp");
