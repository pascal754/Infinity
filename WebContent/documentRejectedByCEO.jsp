...
<%
	...
	System.out.println("documentRejectedByCEO.jsp list.size(): " + list.size());
%>
	...
	<table>
		...
		<%
			...
			for (RejectedDocumentVO x : list) {
				out.println("<tr><td><a href=\"documentRejectedByCEODetail.jsp?docNo=" + x.getDocNo() + "\">" + x.getDocNo()+ "</a></td><td>"
					...
					+ appDao.getApprovedDate(x.getDocNo(), empDao.getTeamLeaderNoFromEmpNo(x.getEmpNo())) + "</td><td>"
					+ x.getRejectedDate()
					+ "</td></tr>"
				);
			}
