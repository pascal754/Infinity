...
<%
	...
	System.out.println("documentCompleteReceiving.jsp list.size(): " + list.size());
%>
	...
	<table>
		...
		<%
			...
			for (DocumentVO x : list) {
				out.println("<tr><td><a href=\"documentCompleteReceivingDetail.jsp?docNo=" + x.getDocNo() + "\">" + x.getDocNo()+ "</a></td><td>"
					 + x.getTitle() + "</td><td>" + x.getContent() + "</td><td>" + appDao.getFinalApprovedDate(x.getDocNo())
					 + "</td></tr>"
				);
			}
			empDao.dbClose();
