...
<%
	...
	System.out.println("documentCompleteInTeamMember.jsp list.size(): " + list.size());
%>
	...
	<table>
		...
		<%
			...
			for (DocumentVO x : list) {
				out.println("<tr><td><a href=\"documentCompleteByTeamMemberDetail.jsp?docNo=" + x.getDocNo() + "\">" + x.getDocNo()+ "</a></td><td>"
