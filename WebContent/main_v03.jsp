...
%>
	<li><a>팀장 문서함</a>&nbsp&nbsp
		<ul>
			<li class="list"><a href="1-1" target="content">수신대기</a>&nbsp&nbsp</li>
			<li class="list on"><a href="1-1" target="content">수신진행</a>&nbsp&nbsp</li>
			...
			<li class="list"><a href="2-3" target="content">발신완료</a></li>
			
		</ul>
		</li>
	<%}else if(title_code==3){ %>
	<li><a>사장 문서함</a>&nbsp&nbsp
		<ul>
			<li><a href="pendingSendingToCEO.do" target="content">대기문서</a>&nbsp&nbsp</li>
			<li><a href="1-2" target="content">완료문서</a></li>
...
%> 
	...
	<li><a>개인 문서함</a>&nbsp&nbsp
		<ul>
			<li class="list on"><a href="draft.jsp" target="content">작성중 문서</a>&nbsp&nbsp</li>
...
<%if(title_code!=3){ %>
	<li><a>팀 수신</a>&nbsp&nbsp
		<ul>
			<li class="list"><a href="3-1" target="content">수신대기</a>&nbsp&nbsp</li>
