...
<%
	...
	Date approvedDate = appDao.getApprovedDate(docNo, docVo.getEmpNo());
	appDao.dbClose();
	...
	System.out.println("**pendingSendingToTeamLeaderDetail.jsp**");
...
<body>
<form action="ReportToCEO.do" method="post">
<div id ="doc_title">
                <p class="t">결재문서</p>
            </div>
