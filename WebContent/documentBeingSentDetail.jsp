...
<%
	...
	Date approvedDate = appDao.getApprovedDate(docNo, Integer.parseInt(id));
            ...
            <div id="approval_line">
                <table class="t">
                    <tr class="t">
                        ...
                        <td class="t">팀장<br><%=teamLeaderVo.getName() %><br><%if (approvedDateTeamLeader == null) out.print("/ / "); else out.print(approvedDateTeamLeader);%></td>
